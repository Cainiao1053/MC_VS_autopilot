...
if cfg == nil then
    ...
    cfg:write("total roll flaps = 20\n");
    cfg:write("total pitch flap = 30\n");
    cfg:write("roll bearing distance each side = 14\n");
    cfg:write("pitch bearing distance = 14\n");
    cfg:write("roll constant = 11091\n");
    cfg:write("pitch constant = 6906\n");
...
if cmd ~= nil and id==commandComputerID then
    rcmd = cmd[1];
    pcmd = cmd[2];
end
